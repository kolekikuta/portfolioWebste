...
const ProjectCard = ({ title, description, imgPath, imgAlt, skills, ghLink, projectPage }) => {
    ...
    return (
        <div className="flex justify-center items-center align-middle w-full my-5 text-white rounded-lg px-6 cursor-pointer hover-translate-y" onClick={() => handleNavigation(projectPage)}>
