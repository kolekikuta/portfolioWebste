...
const ProjectCard = ({ title, description, imgPath, imgAlt, skills, ghLink, projectPage }) => {
    ...
    return (
        <div className="flex justify-center items-center align-middle w-full max-w-6xl my-10 rounded-lg cursor-pointer hover:shadow-lg transition transform duration-300" onClick={() => handleNavigation(projectPage)}>
